            ...
            <div className="flex items-center justify-between h-16">
                ...
                <div className="hidden md:block">
                  <div className="ml-4 flex items-center space-x-4">
                    ...
                    <a href="" className="text-white hover:bg-white hover:text-black rounded-lg p-2"> service</a>
                  </div>                
                </div>
        ...
        {isClick && (
          <div className='md:hidden'>
            ...
            <a href="" className="text-white hover:bg-white block hover:text-black rounded-lg p-2"> home </a>
                    ...
                    <a href="" className="text-white block hover:bg-white hover:text-black rounded-lg p-2"> service</a>
